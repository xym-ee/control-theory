...
*如果是在GitHub看到这些内容，那么可以前往[独立网页](https://xu.yumeng.tech/math)获得更好的浏览体验。*
...
这个笔记本将要整理的内容：围绕控制理论的应用数学知识体系。

- [ ] 基础数学：微积分、线性代数、概率统计、复变函数与积分变换；
- [ ] 从工程到数学：系统建模、动力系统、常微分方程；
- [ ] 经典控制理论，自动控制原理，经典方法，离散系统
- [ ] 矩阵论
- [x] 线性系统理论
- [x] 非线性系统理论：系统稳定性、基本分析方法、控制方法；
- [ ] 最优化方法，最优控制
