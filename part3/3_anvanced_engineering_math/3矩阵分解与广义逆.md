...
$$ \boldsymbol{A}^+ = \boldsymbol{G}^H (\boldsymbol{GG}^H)^{-1} (\boldsymbol{F}^HF)^{-1}\boldsymbol{F}^H $$
...
设 $$ \boldsymbol{A} \in \mathbb{C}^{m \times n} $$ ，$$ \boldsymbol{b} \in \mathbb{C}^m $$， 则 $$ \boldsymbol{Ax} = \boldsymbol{b} $$ 有解的充要条件是 $$ \boldsymbol{AA}^+\boldsymbol{b} = \boldsymbol{b} $$，并且通解为

$$ \boldsymbol{x} = \boldsymbol{A}^+\boldsymbol{b} + ( \boldsymbol{I} - \boldsymbol{A}^+\boldsymbol{A})\boldsymbol{x}_0 \tag{1}$$ 

其中 $$ \boldsymbol{x}_0 \in \mathbb{C}^n $$
